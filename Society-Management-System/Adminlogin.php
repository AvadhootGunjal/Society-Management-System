...
<div class="page">
       <div class="navbar">
           ...
           <h1>Society<span style="font-family: 'Merienda', cursive;
            color:rgb(20, 76, 80);">Manager</span></h1>
           <nav>
               <ul>
    ...
    <footer>
        <div class="main-content">
            <div class="left box">
                ...
                <div class="content">
                    <p>
                        ADK is webapp  where society members can get all the updates related to their society. The members also get notified with notices and events held in society and can see information about members in society. Members can also post complaints regarding any issue in society. 
                    </p>
                </div>
            </div>
            ...
            <div class="right box">
                ...
                <div class="content">
                    <div class="place">
                        ...
                        <span class="text">Palm beach ,Nerul(W)</span>
                    </div>
                    <div class="phone">
                        <span class="fas fa-phone-alt"></span>
                        <span class="text">+91 9322696163</span>
                    </div>
                    <div class="email">
                        <span class="fas fa-envelope"></span>
                        <span class="text">ADK@gmail.com</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="copyright">
            <h3>Copyright @2024|Designed with HTML,CSS,PHP by ADK.</h3>
        </div>
    </footer>
</body>
</html>
